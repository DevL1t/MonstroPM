...
const APP_VERSION = '1.4.0';                     # версия — свойство кода, не конфига (меняется при релизе)
const APP_REPO    = 'DevL1t/MonstroPM';          # официальный репозиторий (для автообновления; хардкод)
